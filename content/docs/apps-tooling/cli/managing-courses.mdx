...
Requires [user authentication](/docs/api/guides/cli/authentication) (wallet login) and teacher access on the course.

## Course Owner Commands

If you own courses (created via on-chain transaction), manage them with the `course owner` subgroup. All require [user authentication](/docs/api/guides/cli/authentication).
...
Teachers manage module lifecycle and review student submissions. All `course teacher` commands require [user authentication](/docs/api/guides/cli/authentication) and teacher access on the course.
...
Students enroll in modules, submit evidence, and claim credentials. All `course student` commands require [user authentication](/docs/api/guides/cli/authentication).
...
For on-chain operations (assignment commitment, evidence update, credential claim), use `tx run` with the appropriate transaction endpoint. See [Transaction Signing](/docs/api/guides/cli/transaction-signing) for the full workflow.
...
See [Transaction Signing](/docs/api/guides/cli/transaction-signing) for the full workflow.
