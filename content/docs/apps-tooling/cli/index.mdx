...
| Guide | Description |
|-------|-------------|
| [Installation](/docs/apps-tooling/cli/installation) | Install the CLI and verify setup |
| [Authentication](/docs/apps-tooling/cli/authentication) | API keys, wallet login, JWT management |
| [Managing Courses](/docs/apps-tooling/cli/managing-courses) | Query courses, teacher module management, student enrollment and credentials |
| [Import & Export](/docs/apps-tooling/cli/import-export) | Round-trip course editing workflow |
| [Import Format](/docs/apps-tooling/cli/import-format) | File format reference for `outline.md`, `lesson-N.md`, etc. |
| [Managing Tasks](/docs/apps-tooling/cli/managing-tasks) | Task bounties, contributor workflows, manager reviews |
| [Task Import & Export](/docs/apps-tooling/cli/task-import-export) | Edit tasks as Markdown files and sync changes |
| [Transaction Signing](/docs/apps-tooling/cli/transaction-signing) | Sign and submit Cardano transactions with a local `.skey` file |
| [Hash Verification](/docs/apps-tooling/cli/hash-verification) | Compute and verify Blake2b-256 content hashes |
