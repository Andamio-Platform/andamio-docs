...
| Guide | Description |
|-------|-------------|
| [Installation](/docs/api/guides/cli/installation) | Install the CLI and verify setup |
| [Authentication](/docs/api/guides/cli/authentication) | API keys, wallet login, JWT management |
| [Managing Courses](/docs/api/guides/cli/managing-courses) | Query courses, teacher module management, student enrollment and credentials |
| [Import & Export](/docs/api/guides/cli/import-export) | Round-trip course editing workflow |
| [Import Format](/docs/api/guides/cli/import-format) | File format reference for `outline.md`, `lesson-N.md`, etc. |
| [Managing Tasks](/docs/api/guides/cli/managing-tasks) | Task bounties, contributor workflows, manager reviews |
| [Task Import & Export](/docs/api/guides/cli/task-import-export) | Edit tasks as Markdown files and sync changes |
| [Transaction Signing](/docs/api/guides/cli/transaction-signing) | Sign and submit Cardano transactions with a local `.skey` file |
| [Hash Verification](/docs/api/guides/cli/hash-verification) | Compute and verify Blake2b-256 content hashes |
