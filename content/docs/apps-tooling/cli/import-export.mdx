...
Edit any of the exported files with your preferred editor. See the [Import Format](/docs/api/guides/cli/import-format) reference for file format details.
...
**Requires** [user authentication](/docs/api/guides/cli/authentication) (wallet login).
