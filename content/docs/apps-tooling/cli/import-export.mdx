...
Edit any of the exported files with your preferred editor. See the [Import Format](/docs/apps-tooling/cli/import-format) reference for file format details.
...
**Requires** [user authentication](/docs/apps-tooling/cli/authentication) (wallet login).
