...
- [Transaction Signing](/docs/apps-tooling/cli/transaction-signing) — Sign and submit transactions
- [Managing Courses](/docs/apps-tooling/cli/managing-courses) — Course content operations
- [Managing Tasks](/docs/apps-tooling/cli/managing-tasks) — Task lifecycle commands
