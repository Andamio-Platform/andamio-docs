...
- [Transaction Signing](/docs/api/guides/cli/transaction-signing) — Sign and submit transactions
- [Managing Courses](/docs/api/guides/cli/managing-courses) — Course content operations
- [Managing Tasks](/docs/api/guides/cli/managing-tasks) — Task lifecycle commands
