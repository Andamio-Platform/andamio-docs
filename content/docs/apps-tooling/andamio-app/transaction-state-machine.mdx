...
- [Transaction lifecycle — README](https://github.com/Andamio-Platform/andamio-app-template#how-transactions-work)
- [Safe refetch timing — API Concepts](/docs/api/core/api-concepts#safe-refetch-timing)
...
For state descriptions and the `confirmed` vs `updated` distinction see [Monitoring State Changes — API Concepts](/docs/api/core/api-concepts#monitoring-state-changes) and the [app template README](https://github.com/Andamio-Platform/andamio-app-template#how-transactions-work).
