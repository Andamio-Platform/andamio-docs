...
- [V2 Transactions](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/v2) - Complete reference for current transactions
- [Utilities](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/utilities) - Hash functions and CBOR decoder
- [Side Effects](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/side-effects) - Database update patterns
- [Input Helpers](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/input-helpers) - Format complex inputs

## Protocol Reference

Each transaction in the SDK maps to an on-chain protocol spec. See the [Protocol V2 Documentation](/docs/protocol/v2) for validators, tokens, and the full [transaction state machine](/docs/protocol/v2#the-transaction-lifecycle).
