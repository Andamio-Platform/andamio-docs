...
<Cards>
  <Card title="Type-Safe Definitions" href="/docs/apps-tooling/sdk/npm-packages/andamio-transactions/getting-started" icon={<Code />}>
    Full TypeScript support with Zod validation for all transaction inputs
  </Card>
  <Card title="Input Helpers" href="/docs/apps-tooling/sdk/npm-packages/andamio-transactions/input-helpers" icon={<Layers />}>
    Format complex inputs with type-safe helper functions
  </Card>
  <Card title="Side Effects" href="/docs/apps-tooling/sdk/npm-packages/andamio-transactions/side-effects" icon={<Zap />}>
    Declarative database updates and notifications
  </Card>
  <Card title="Hash Utilities" href="/docs/apps-tooling/sdk/npm-packages/andamio-transactions/utilities" icon={<Shield />}>
...
- [Getting Started](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/getting-started) - Installation and basic usage
- [Transactions](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/v2) - Production transactions
- [Utilities](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/utilities) - Hash functions and helpers
- [Side Effects](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/side-effects) - Database update patterns
