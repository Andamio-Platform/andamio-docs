...
const result = await executeOnSubmit(txDef.onSubmit, context, {
  apiBaseUrl: process.env.NEXT_PUBLIC_ANDAMIO_GATEWAY_URL!,
...
- [Getting Started](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/getting-started) - Basic usage
- [V2 Transactions](/docs/apps-tooling/sdk/npm-packages/andamio-transactions/v2) - Transaction reference with side effects
