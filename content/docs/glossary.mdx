...
### Project Owner
Instance-specific role for Access Token Holders in Project Local States. Initial Project Owner is assigned at instance creation and can add additional Project Owners. Manage treasury, approve commitments, and define task requirements within their specific instance. Can also participate as Contributors.
