...
### Protocol V2
Second major version of Andamio Protocol smart contracts, [independently audited](/docs/protocol/v2/security-audit) by TxPipe. Improvements in scalability, security, and features.
...
Feature allowing organizations to pay blockchain transaction fees on behalf of users, removing Web3 adoption barriers. Available to enterprise API keys — see [Sponsored Transactions](/docs/api/guides/sponsored-transactions).
