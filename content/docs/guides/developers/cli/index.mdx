...
| On-chain commitment with evidence | `andamio course student commit-tx --course-id <id> --module-code 101 --evidence-file ./evidence.md --skey ./key.skey` |
...
| On-chain commitment with evidence | `andamio project contributor commit-tx --project-id <id> --task-index 0 --evidence-file ./evidence.md --skey ./key.skey` |
