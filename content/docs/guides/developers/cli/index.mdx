...
| Create a task with token rewards | `andamio project task create <project-id> --title "..." --lovelace 5000000 --expiration 2026-06-01` |
...
| Sign and submit (step by step) | `andamio tx build` then `tx sign` then `tx submit` then `tx register` |
