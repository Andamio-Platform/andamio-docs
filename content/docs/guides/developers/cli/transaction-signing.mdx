...
For hash verification and diagnostics (compute-hash, verify-hash for both courses and tasks), see [Hash Verification](/docs/guides/developers/cli/hash-verification).
