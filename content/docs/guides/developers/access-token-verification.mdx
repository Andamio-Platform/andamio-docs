...
| Scenario | Use |
|----------|-----|
| Your app calls Andamio API endpoints | [Wallet Authentication](/docs/guides/developers/authentication) — get a User JWT |
...
- [Developer Accounts](/docs/guides/developers/developer-accounts) — The three credential types explained
- [Authentication](/docs/guides/developers/authentication) — Wallet-based login for API access
