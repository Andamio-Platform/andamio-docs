...
|------|---------|------------|
| `400` | Bad request / validation error | Check request body against [API Reference](https://api.andamio.io/reference) |
...
curl -H "X-API-Key: $API_KEY" \
  https://api.andamio.io/api/v2/tx/status/$TX_HASH
```
...
curl -H "X-API-Key: $API_KEY" \
  ...
  https://api.andamio.io/api/v2/tx/pending
```
...
- [API Reference](https://api.andamio.io/reference) — Endpoint documentation
