...
Andamio uses three credential types. This page covers **User JWT** (wallet-based authentication for end users). For the other two, see the links below.

| Credential | Purpose | Guide |
|-----------|---------|-------|
| **API Key** | Application identity — required on every request | [API Keys](/docs/guides/developers/api-keys) |
