...
Andamio uses wallet-based authentication. Users prove ownership of their Cardano wallet by signing a cryptographic challenge, and receive a JWT that authorizes API requests.
