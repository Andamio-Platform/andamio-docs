...
> **API Reference**: For endpoint schemas, request/response formats, and parameter details, see the [Andamio API Reference](https://preprod.api.andamio.io/reference).
...
- [API Reference](https://preprod.api.andamio.io/reference) — Full endpoint documentation
