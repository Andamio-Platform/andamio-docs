...
description: Complete workflow for building, signing, and tracking Andamio transactions
---
...
> **API Reference**: For endpoint schemas, request/response formats, and parameter details, see the [Andamio API Reference](https://api.andamio.io/reference).
...
**Note**: Some endpoints share the same TX type. See [TX Type Mapping](/docs/protocol/v2/state-machine#tx-type-mapping) for details.
...
- [API Reference](https://api.andamio.io/reference) — Full endpoint documentation
