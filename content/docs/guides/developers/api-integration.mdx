...
> **API Reference**: For endpoint schemas and parameter details, see the [Preprod API Docs](https://preprod.api.andamio.io). When ready for production, use `api.andamio.io`.
...
Start development on **preprod** — it uses test ADA and is safe to experiment with.

| Environment | Gateway URL | App URL | Network |
|-------------|-------------|---------|---------|
| **Preprod** (start here) | `dev-api.andamio.io` | [preprod.app.andamio.io](https://preprod.app.andamio.io) | Cardano Preprod |
| Production | `api.andamio.io` | [app.andamio.io](https://app.andamio.io) | Cardano Mainnet |
