...
Andamio uses three types of credentials. Understanding which you need is the first step to building on the platform.

## Three Credential Types

| Credential | What It Is | How to Get It | When to Use It |
|------------|-----------|---------------|----------------|
| **API Key** | Application identity — "who's asking" | Register a developer account, then request a key | Every API request (`X-API-Key` header) |
...
API Key is always required. User JWT is required for write operations. Attestation JWT is for third-party integrations that need to verify identity offline.
