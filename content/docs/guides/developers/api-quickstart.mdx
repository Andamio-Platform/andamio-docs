...
```bash
curl -X GET "https://dev-api.andamio.io/health"
```
...
```bash
curl -X GET "https://dev-api.andamio.io/api/v2/instance/courses" \
...
```bash
curl -X GET "https://dev-api.andamio.io/api/v2/course/dbd4f125.../modules" \
  -H "X-API-Key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://dev-api.andamio.io/api/v2/project/PROJECT_ID/tasks" \
  -H "X-API-Key: YOUR_API_KEY"
```
...
- **[API Reference](https://dev-api.andamio.io/api/v1/docs/index.html)** — Full endpoint documentation
