...
- **Budget Utilization** = (Rewards Distributed + Platform Fees) / Total Deposited — visible on the [Reports tab](/docs/guides/projects/reports)

## What's Next

- [Task Management](/docs/guides/projects/task-management) — create draft tasks before publishing
- [Reports](/docs/guides/projects/reports) — track treasury activity and export financial reports
