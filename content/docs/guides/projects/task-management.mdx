...
You manage drafts and live tasks from the **Tasks** tab. Publishing happens through the [Treasury Management](/docs/guides/projects/treasury-management) page. Reviewing submissions happens through the [Assessment Workflow](/docs/guides/projects/assessment-workflow).
...
Publishing moves drafts on-chain, locks their reward ADA in the treasury, and makes them available to contributors. The full publishing flow is covered in the [Treasury Management guide](/docs/guides/projects/treasury-management), but here's the short version:
...
- **Expired** tasks still hold locked ADA in the treasury until you explicitly remove them through [Treasury Management](/docs/guides/projects/treasury-management).
...
The main thing to watch for: **Pending Review** badges mean a contributor is waiting on you. Click through to review their submission in the [Assessment Workflow](/docs/guides/projects/assessment-workflow).

Expired and cancelled tasks appear in a separate "Other Tasks" section below the live table.

## What's Next

- [Treasury Management](/docs/guides/projects/treasury-management) — fund the treasury, publish drafts on-chain, reclaim ADA from expired tasks
- [Assessment Workflow](/docs/guides/projects/assessment-workflow) — review contributor submissions and make accept/refuse/deny decisions
