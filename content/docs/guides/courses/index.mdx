...
<Cards>
  <Card title="Creating Your First Course" href="/docs/guides/courses/creating-your-first-course">
    Step-by-step walkthrough from setup to first enrollment
  </Card>
  <Card title="Managing Students and Grading" href="/docs/guides/courses/managing-students">
...
Want to understand what's happening on-chain? See the [Course Protocol](/docs/protocol/v2/validators/course) for validators and state management, or browse [Course Transactions](/docs/protocol/v2/transactions/course) for the full transaction lifecycle.
