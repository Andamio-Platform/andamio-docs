...
This section documents Andamio's on-chain protocol (validators, transactions, tokens, state machine). Most builders don't need it — start with the [API](/docs/api/getting-started) and [Andamio Issuer](/docs/issuer). It's kept here as a reference for protocol integrators.
</Callout>
...
> **Ready to dive in?** See the full [Protocol V2 Documentation](/docs/protocol/v2) for validators, transactions, and tokens. Or try the [Platform Guides](/docs/apps-tooling) for hands-on walkthroughs.
