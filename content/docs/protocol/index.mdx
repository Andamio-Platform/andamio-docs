...
- **[Global State](/docs/protocol/v2/validators)**: Foundation layer for identity and system-wide configuration
- **[Course Protocol](/docs/protocol/v2/validators)**: Learning and credential issuance
- **[Project Protocol](/docs/protocol/v2/validators)**: Collaborative work and reward distribution

Each system builds on the previous layers, creating a powerful, interoperable system for distributed work and learning.

> **Ready to dive in?** See the full [Protocol Documentation](/docs/protocol/v2) for the four-layer model, validators, and transaction sequences. Or try the [Platform Guides](/docs/apps-tooling) for hands-on walkthroughs.
...
**1. Andamio Access Token and Self-Sovereign On-chain Identity (SSOI)**: Anyone can mint an [access token](/docs/protocol/v2/validators) to create a unique identity on Andamio.

**2. Earning Credentials for Learning**: Access token holders complete [Courses](/docs/protocol/v2/validators), earning verifiable credentials.

**3. Project Enrollment**: When a [Project](/docs/protocol/v2/validators) requires specific skills, contributors with the necessary credentials can enroll.
