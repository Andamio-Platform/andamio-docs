...
> [Protocol Documentation](/docs/protocol/v2)

## Goals of this Documentation

1. **End users**: Clear guides for participating in courses and projects on Andamio.
2. **Developers**: Technical resources to build on and integrate with the Andamio Protocol.
3. **Decision makers**: Strategic understanding of how Andamio enables credential-gated collaboration.
