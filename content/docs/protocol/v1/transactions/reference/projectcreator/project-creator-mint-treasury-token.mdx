...
![Transaction Diagram](/diagrams/protocol/project-creator-mint-treasury-token.png)

## API Reference

### Endpoint
```
POST /tx/v0/projectcreator/mint-treasury-token
```
...
const result = await api.transactions.projectCreatorMintTreasuryToken({
...
result = api.transactions.project_creator_mint_treasury_token(
