...
![Transaction Diagram](/diagrams/protocol/student-commit-to-assignment.png)

## API Reference

### Endpoint
```
POST /tx/v0/student/commit-to-assignment
```
...
const result = await api.transactions.studentCommitToAssignment({
...
result = api.transactions.student_commit_to_assignment(
