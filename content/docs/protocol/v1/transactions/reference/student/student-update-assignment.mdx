...
![Transaction Diagram](/diagrams/protocol/student-update-assignment.png)

## API Reference

### Endpoint
```
POST /tx/v0/student/update-assignment
```
...
const result = await api.transactions.studentUpdateAssignment({
...
result = api.transactions.student_update_assignment(
