...
![Transaction Diagram](/diagrams/protocol/course-creator-accept.assignment.png)

## API Reference

### Endpoint
```
POST /tx/v0/coursecreator/accept.assignment
```
...
const result = await api.transactions.courseCreatorAccept.Assignment({
...
result = api.transactions.course_creator_accept.assignment(
