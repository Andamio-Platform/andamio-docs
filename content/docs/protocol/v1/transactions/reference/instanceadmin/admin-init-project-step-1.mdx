...
![Transaction Diagram](/diagrams/protocol/admin-init-project-step-1.png)

## API Reference

### Endpoint
```
POST /tx/v0/instanceadmin/init-project-step-1
```
...
const result = await api.transactions.adminInitProjectStep1({
...
result = api.transactions.admin_init_project_step_1(
