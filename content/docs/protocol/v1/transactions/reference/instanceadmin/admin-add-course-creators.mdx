...
![Transaction Diagram](/diagrams/protocol/admin-add-course-creators.png)

## API Reference

### Endpoint
```
POST /tx/v0/instanceadmin/add-course-creators
```
...
const result = await api.transactions.adminAddCourseCreators({
...
result = api.transactions.admin_add_course_creators(
