...
This transaction is performed by **InstanceAdmin** users and falls under the **Course Management** category.
...
![Transaction Diagram](/diagrams/protocol/admin-init-course.png)

## API Reference

### Endpoint
```
POST /tx/v0/instanceadmin/init-course
```
...
const result = await api.transactions.adminInitCourse({
...
result = api.transactions.admin_init_course(
