...
The Index Validator manages on-chain linked list data structures used throughout the Andamio protocol. This validator is part of the index blueprint and handles the core indexing functionality.
