...
### 3. Your Challenge: Run the Andamio App Template Locally

- Share Github handle
- Clone and run the [Andamio App Template](https://github.com/Andamio-Platform/andamio-app-template) locally
- Submit [issues to the project repository on Github](https://github.com/Andamio-Platform/andamio-app-template/issues)
...
- App Template coverage of API endpoints
...
On-chain data reconstruction is a design goal of the Andamio protocol — application state can be fully rebuilt from blockchain data.
...
All transactions have corresponding MDX pages at `/docs/protocol/v2/sequences/`.
