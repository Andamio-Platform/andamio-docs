...
- Share Github handle
- Get access to [Andamio T3 App Template](https://github.com/Andamio-Platform/andamio-app-v2), and run it locally
- Submit [issues to the project repository on Github](https://github.com/Andamio-Platform/andamio-app-v2/issues)
