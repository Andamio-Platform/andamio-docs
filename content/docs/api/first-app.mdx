...
**Time**: ~30 minutes. **Prerequisite**: [Getting Started](/docs/api/getting-started).
...
- **[Transaction Handling](/docs/api/core/transactions)** — Error handling, retries, and confirmation tracking
- **[API Integration](/docs/api/accounts/api-integration)** — Deep dive into the Gateway API
