...
- **Cardano wallet on preprod with test ADA** — [Setup guide](/docs/apps-tooling/preprod-wallet-setup)
</Callout>
...
<Cards>
  <Card title="Your First Transaction" href="/docs/api/guides/first-app">
    Build something real — create a course and enroll a student
  </Card>
  <Card title="API Integration" href="/docs/api/guides/api-integration">
    Understand the build → sign → submit flow
  </Card>
  <Card title="Environment Reference" href="/docs/api/reference/environments">
