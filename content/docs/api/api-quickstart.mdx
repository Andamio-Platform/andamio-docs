...
2. Connect your wallet (you'll need an Access Token — [mint one first](/docs/api/getting-started) if needed)
3. Select **preprod**
...
See [Authentication](/docs/api/accounts/authentication) for the full JWT flow.

---

## Next Steps

- **[Authentication](/docs/api/accounts/authentication)** — User login with wallet signatures
