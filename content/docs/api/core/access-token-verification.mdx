...
| Scenario | Use |
|----------|-----|
| Your app calls Andamio API endpoints | [Wallet Authentication](/docs/api/accounts/authentication) — get a User JWT |
...
- [Developer Accounts](/docs/api/accounts/developer-accounts) — The three credential types explained
- [Authentication](/docs/api/accounts/authentication) — Wallet-based login for API access
