...
> **Deep dive**: For state transitions, error handling patterns, and architecture details, see [Transaction State Machine](/docs/apps-tooling/andamio-app/transaction-state-machine).
...
- [Transaction State Machine](/docs/apps-tooling/andamio-app/transaction-state-machine) — Deep dive into state transitions
