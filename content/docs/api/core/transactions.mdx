...
> **Deep dive**: For state transitions, error handling patterns, and architecture details, see [Transaction Lifecycle](/docs/protocol/v2#the-transaction-lifecycle). Building on the app template? See also [Transaction State Machine — app template implementation](/docs/apps-tooling/andamio-app/transaction-state-machine).
...
|----------------|---------|-------|
| `/tx/global/user/access-token/mint` | `access_token_mint` | — |
...
- [Transaction Lifecycle](/docs/protocol/v2#the-transaction-lifecycle) — Protocol-level state transitions
- [Transaction State Machine](/docs/apps-tooling/andamio-app/transaction-state-machine) — App template implementation details
