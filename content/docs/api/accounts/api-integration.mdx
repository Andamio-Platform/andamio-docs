...
| Verification | `/api/v2/verify/*` | Access token ownership proof | [Verification](/docs/api/core/access-token-verification) |
...
| Events | `/api/v2/events/*` | Parse what happened in a confirmed transaction | [API Concepts](/docs/api/core/api-concepts) |
