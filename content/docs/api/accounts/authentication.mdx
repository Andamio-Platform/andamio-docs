...
Andamio uses [four credential types](/docs/api/accounts/developer-accounts#credential-types). This page covers **User JWT** — wallet-based authentication for end users.
...
| **Attestation JWT** | Offline identity proof for third parties | [Access Token Verification](/docs/api/core/access-token-verification) |
...
- [Developer Accounts](/docs/api/accounts/developer-accounts) — Developer registration, email verification, Attestation JWT
