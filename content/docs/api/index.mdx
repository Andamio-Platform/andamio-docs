...
- **[Type Conventions](/docs/api/type-conventions)** - Field naming, identifier patterns, and response structures
- **[TX State Machine](/docs/api/tx-state-machine)** - Transaction lifecycle management
