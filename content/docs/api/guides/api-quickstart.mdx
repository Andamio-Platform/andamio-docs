...
See [Authentication](/docs/api/guides/authentication) for the full JWT flow.

---

## Next Steps

- **[Authentication](/docs/api/guides/authentication)** — User login with wallet signatures
