...
Andamio uses [four credential types](/docs/api/guides/developer-accounts#credential-types). This page covers **User JWT** — wallet-based authentication for end users.

| Credential | Purpose | Guide |
|-----------|---------|-------|
| **API Key** | Application identity — required on most requests | [API Keys](/docs/api/guides/api-keys) |
| **User JWT** | User identity — wallet-signed, authorizes actions | This page |
| **Developer JWT** | Account management — email/password login | [Developer Accounts](/docs/api/guides/developer-accounts) |
| **Attestation JWT** | Offline identity proof for third parties | [Access Token Verification](/docs/api/guides/access-token-verification) |
...
- [Developer Accounts](/docs/api/guides/developer-accounts) — Developer registration, email verification, Attestation JWT
...
- [Transaction Handling](/docs/api/guides/transactions) — Build and submit transactions
