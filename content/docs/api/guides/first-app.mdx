...
- **[Transaction Handling](/docs/api/guides/transactions)** — Error handling, retries, and confirmation tracking
- **[API Integration](/docs/api/guides/api-integration)** — Deep dive into the Gateway API
