...
1. [Register a developer account](/docs/api/guides/developer-accounts)
...
The number of keys you can create depends on your [billing tier](/docs/api/guides/billing).
...
- [Billing](/docs/api/guides/billing) — Pricing tiers, rate limits, and quotas
- [API Integration](/docs/api/guides/api-integration) — Using your key in requests
- [Developer Accounts](/docs/api/guides/developer-accounts) — Registration and email verification
