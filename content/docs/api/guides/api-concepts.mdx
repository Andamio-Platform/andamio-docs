---
title: API Concepts
description: Source field architecture, safe refetch timing, merged endpoints, and event queries
---
...
- [Transaction Handling](/docs/api/guides/transactions) — The full transaction lifecycle
- [Error Handling](/docs/api/guides/error-handling) — Failure modes and recovery
