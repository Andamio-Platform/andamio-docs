...
const CROSS_REFERENCES = {
  ...
  transactionTypes: {
    ...
    'StudentCourseAssignmentCommit': '/docs/protocol/v2/transactions/course/student/assignment/commit',
  ...
  endpoints: {
    ...
    '/v2/transactions/studentcourse/assignment_commit': '/docs/protocol/v2/transactions/course/student/assignment/commit',
